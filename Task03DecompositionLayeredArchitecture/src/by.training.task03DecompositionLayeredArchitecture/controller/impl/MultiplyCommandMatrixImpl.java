...
public class MultiplyCommandMatrixImpl implements CommandMatrix {

    static final Logger multiplyCommandImplLogger = LogManager.getLogger(MultiplyCommandMatrixImpl.class.getName());
